...
!function (t, e) {
    ...
    return e = window.document, function () {
        ...
        return o.prototype.addSteps = function (t) {
            ...
            return o = function (o) {
                return function (n) {
                    if (t(e).off("click.tour-" + o._options.name), t(e).off("keyup.tour-" + o._options.name), o._setState("end", "yes"), o._inited = !1, o._force = !1, o._clearTimer(), null != o._options.onEnd) return o._options.onEnd(o)
                }
            ...
            return t(".tour-" + this._options.name).remove(), r = t.extend({}, this._options), i = this._isOrphan(e), e.template = this._template(e, o), i && (e.element = "body", e.placement = "top"), (n = t(e.element)).addClass("tour-" + this._options.name + "-element tour-" + this._options.name + "-" + o + "-element"), e.options && t.extend(r, e.options), e.reflex && !i && t(e.reflexElement).addClass("tour-step-element-reflex").off(this._reflexEvent(e.reflex) + ".tour-" + this._options.name).on(this._reflexEvent(e.reflex) + ".tour-" + this._options.name, function (t) {
                ...
                template: e.template,
                selector: e.element
            }).popover("show"), t(n.data("bs.popover").getTipElement()).attr("id", e.id)
            ...
            return this._debug("Scroll into view. ScrollTop: " + a + ". Element offset: " + s + ". Window height: " + p + "."), i = 0, t("body, html").stop(!0, !0).animate({scrollTop: Math.ceil(a)}, function (t) {
                return function () {
            ...
            for (s = t(e).height(), c = t(e).width(), l = [], a = 0, h = (u = ["top", "bottom", "left", "right"]).length; a < h; a++) switch (p = u[a], i = null != (r = this.backdrops)[p] ? r[p] : r[p] = t("<div>", {class: "tour-backdrop " + p}), t(o.backdropContainer).append(i), p) {
                case"top":
                    l.push(i.height(n.offset.top > 0 ? n.offset.top : 0).width(c).offset({top: 0, left: 0}));
                    break;
                case"bottom":
                    l.push(i.offset({
